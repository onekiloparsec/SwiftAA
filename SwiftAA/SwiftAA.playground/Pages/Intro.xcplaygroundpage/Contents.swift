...
//:
//: ## Foreword
//: SwiftAA is the most complete and accurate set of astronomical algorithms available for Swift, period.
//: It originates from the development of a professionnal app called [iObserve](http://onekilopars.ec/iobserve)
//: and available since 2010 on the Mac.
//: This app has also been ported to iPad, has been downloaded thousands of times around the world, and is used in all
//: major observatories in the world, from world-class VLT, Keck, Gemini to smaller ones in people's backyard.
...
//: implement lots of them. And a good programmer knows when to reuse code... So I contacted Paul J. Naughter, whose
//: [website](http://www.naughter.com/aa.html) 
...
//: 
//: SwiftAA was first developed for an easy use in the development of apps, among which the coming iObserve2. 
...
//:
//: To achieve this goal, SwiftAA has been exented to not only contains AA+ algorithms, but also much more expressive
