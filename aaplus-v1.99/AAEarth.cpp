...
double CAAEarth::EclipticLatitude(double JD, bool bHighPrecision)
{
  ...
  //Calculate B0
  const int nB0Coefficients = sizeof(g_B0EarthCoefficients) / sizeof(VSOP87Coefficient);
  double B0 = 0;
  for (int i=0; i<nB0Coefficients; i++)
    B0 += g_B0EarthCoefficients[i].A * cos(g_B0EarthCoefficients[i].B + g_B0EarthCoefficients[i].C*rho);

  //Calculate B1
  const int nB1Coefficients = sizeof(g_B1EarthCoefficients) / sizeof(VSOP87Coefficient);
  double B1 = 0;
...
double CAAEarth::EclipticLongitudeJ2000(double JD, bool bHighPrecision)
{
  ...
  //Calculate L1
  const int nL1Coefficients = sizeof(g_L1EarthCoefficientsJ2000) / sizeof(VSOP87Coefficient);
  double L1 = 0;
  for (int i=0; i<nL1Coefficients; i++)
    L1 += g_L1EarthCoefficientsJ2000[i].A * cos(g_L1EarthCoefficientsJ2000[i].B + g_L1EarthCoefficientsJ2000[i].C*rho);

  //Calculate L2
  const int nL2Coefficients = sizeof(g_L2EarthCoefficientsJ2000) / sizeof(VSOP87Coefficient);
  double L2 = 0;
  for (int i=0; i<nL2Coefficients; i++)
    L2 += g_L2EarthCoefficientsJ2000[i].A * cos(g_L2EarthCoefficientsJ2000[i].B + g_L2EarthCoefficientsJ2000[i].C*rho);

  //Calculate L3
  const int nL3Coefficients = sizeof(g_L3EarthCoefficientsJ2000) / sizeof(VSOP87Coefficient);
  double L3 = 0;
  for (int i=0; i<nL3Coefficients; i++)
    L3 += g_L3EarthCoefficientsJ2000[i].A * cos(g_L3EarthCoefficientsJ2000[i].B + g_L3EarthCoefficientsJ2000[i].C*rho);

  //Calculate L4
  const int nL4Coefficients = sizeof(g_L4EarthCoefficientsJ2000) / sizeof(VSOP87Coefficient);
  double L4 = 0;
  for (int i=0; i<nL4Coefficients; i++)
...
double CAAEarth::EclipticLatitudeJ2000(double JD, bool bHighPrecision)
{
  ...
  //Calculate B1
  const int nB1Coefficients = sizeof(g_B1EarthCoefficientsJ2000) / sizeof(VSOP87Coefficient);
  double B1 = 0;
  for (int i=0; i<nB1Coefficients; i++)
    B1 += g_B1EarthCoefficientsJ2000[i].A * cos(g_B1EarthCoefficientsJ2000[i].B + g_B1EarthCoefficientsJ2000[i].C*rho);

  //Calculate B2
  const int nB2Coefficients = sizeof(g_B2EarthCoefficientsJ2000) / sizeof(VSOP87Coefficient);
  double B2 = 0;
  ...
  //Calculate B3
  const int nB3Coefficients = sizeof(g_B3EarthCoefficientsJ2000) / sizeof(VSOP87Coefficient);
  double B3 = 0;
  ...
  //Calculate B4
  const int nB4Coefficients = sizeof(g_B4EarthCoefficientsJ2000) / sizeof(VSOP87Coefficient);
  double B4 = 0;
