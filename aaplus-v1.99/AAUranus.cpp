...
double CAAUranus::EclipticLongitude(double JD, bool bHighPrecision)
{
  ...
  //Calculate L0
  const int nL0Coefficients = sizeof(g_L0UranusCoefficients) / sizeof(VSOP87Coefficient);
  double L0 = 0;
  ...
  //Calculate L1
  const int nL1Coefficients = sizeof(g_L1UranusCoefficients) / sizeof(VSOP87Coefficient);
  double L1 = 0;
  ...
  //Calculate L2
  const int nL2Coefficients = sizeof(g_L2UranusCoefficients) / sizeof(VSOP87Coefficient);
  double L2 = 0;
  ...
  //Calculate L3
  const int nL3Coefficients = sizeof(g_L3UranusCoefficients) / sizeof(VSOP87Coefficient);
  double L3 = 0;
  ...
  //Calculate L4
  const int nL4Coefficients = sizeof(g_L4UranusCoefficients) / sizeof(VSOP87Coefficient);
  double L4 = 0;
...
double CAAUranus::EclipticLatitude(double JD, bool bHighPrecision)
{
  ...
  //Calculate B0
  const int nB0Coefficients = sizeof(g_B0UranusCoefficients) / sizeof(VSOP87Coefficient);
  double B0 = 0;
  ...
  //Calculate B1
  const int nB1Coefficients = sizeof(g_B1UranusCoefficients) / sizeof(VSOP87Coefficient);
  double B1 = 0;
  ...
  //Calculate B2
  const int nB2Coefficients = sizeof(g_B2UranusCoefficients) / sizeof(VSOP87Coefficient);
  double B2 = 0;
  ...
  //Calculate B3
  const int nB3Coefficients = sizeof(g_B3UranusCoefficients) / sizeof(VSOP87Coefficient);
  double B3 = 0;
  ...
  //Calculate B4
  const int nB4Coefficients = sizeof(g_B4UranusCoefficients) / sizeof(VSOP87Coefficient);
  double B4 = 0;
...
double CAAUranus::RadiusVector(double JD, bool bHighPrecision) noexcept
{
  ...
  //Calculate R0
  const int nR0Coefficients = sizeof(g_R0UranusCoefficients) / sizeof(VSOP87Coefficient);
  double R0 = 0;
  ...
  //Calculate R1
  const int nR1Coefficients = sizeof(g_R1UranusCoefficients) / sizeof(VSOP87Coefficient);
  double R1 = 0;
  ...
  //Calculate R2
  const int nR2Coefficients = sizeof(g_R2UranusCoefficients) / sizeof(VSOP87Coefficient);
  double R2 = 0;
  ...
  //Calculate R3
  const int nR3Coefficients = sizeof(g_R3UranusCoefficients) / sizeof(VSOP87Coefficient);
  double R3 = 0;
...
//Calculate R4
  const int nR4Coefficients = sizeof(g_R4UranusCoefficients) / sizeof(VSOP87Coefficient);
  double R4 = 0;
